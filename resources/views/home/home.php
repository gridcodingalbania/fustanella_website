<div style="background: #F5F5F5;">
    ...
    <div class="mt-[50px] text-center">
        ...
        <a href=""><button class="flex m-auto red-hat 2xl:text-[22px] lg:text-[22px] md:text-[19px] sm:text-[19px] text-[16px] 2xl:my-[80px] lg:my-[80px] md:my-[70px] sm:my-[70px] my-[30px] 2xl:font-[500] sm:font-[500] font-[400] hoverSm">See more <img class="m-auto pl-[10px]" src="<?php the_field('see_more_image2'); ?>" alt=""></button></a>
    </div>
