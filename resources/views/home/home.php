<div style="background: #F5F5F5;">
   <div >
    <span class="2xl:block nav:hidden"><?php echo do_shortcode( '[URIS id=65]' ); ?></span>
    ...
    <div class="table absolute w-full top-0 left-0 z-3">
        ...
        <p id="MobMain" class="text-white cormorant 2xl:text-[70px] xl:text-[50px] nav:text-[60px] sm:text-[60px] text-[40px] 2xl:leading-[106px] xl:leading-[80px] md:leading-[70px] sm:leading-[70px] leading-[70px] 2xl:mt-0 nav:mt-[200px] md:mt-[100px] sm:mt-[100px] mt-[120px] 2xl:mx-0 md:mx-[20%] sm:mx-[20%] mx-[80px]">
            <?php the_field('main_text_first_line'); ?><br>
            <span class="witter 2xl:text-[128px] sm:text-[100px] text-[70px]"> <?php the_field('main_text_second_line_first_word'); ?></span> <?php the_field('main_text_second_line'); ?>
        </p>
         <div id="buttonMainMob" class="2xl:flex nav:grid justify-center text-white gap-[16px] 2xl:mt-[100px] xl:mt-[80px] md:mt-[50px] mt-[80px]">
           <button class="px-[65px] py-[15px]  border  border-white"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px]"><?php the_field('book_a_table_button'); ?></span></button>
           <button class="px-[65px] py-[15px]  border  border-white 2xl:mt-0 nav:mt-[5%] mt-0"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px]"><?php the_field('book_a_room_button'); ?></span></button>
         </div>
    </div>
    </div>
    
   </div>
   <div class="mt-[130px] mb-[184px] mx-[50px]">
    ...
    <div class="mt-[157px] text-center">
        ...
        <button class="flex m-auto red-hat text-[22px] my-[80px]  font-medium">See more <img class="m-auto pl-[10px]" src="<?php the_field('see_more_image2'); ?>" alt=""></button>
    </div>
