    ...
    <div class="w-5/6 mx-auto">
        <div class="flex flex-col items-center justify-center h-[90vh]">
            ...
            <div class="calendar">
                ...
                <div class="days mt-2 mb-5">

                </div>
            </div>
            <div class="grid grid-cols-2 gap-6 justify-items-stretch w-[900px] mx-auto pt-5">
                <div class="flex flex-row items-center justify-between bg-gray94 h-[100px] p-5">
                    <p class="red-hat text-[20px]">Choose Time</p>
                    <input type="time" class="border border-black bg-transparent text-[20px] p-2" />
                </div>
            ...
            <div class="w-[900px] grid grid-cols-3 gap-24  justify-items-center items-center p-3 mt-5 bg-egreen">
            ...
            <input type="button" value="Apply" class="uppercase mt-12 border-2 border-headingColor text-headingColor text-xl w-[400px] h-[60px] cursor-pointer" />
        </div>

    </div>
</div>

<script src="<?php echo get_fustanella_scripts("calendar.js"); ?>"></script>
<script src="<?php echo get_fustanella_scripts("booking.js"); ?>"></script>
