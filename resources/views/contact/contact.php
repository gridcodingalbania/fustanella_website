<div class="bg-gray94 w-full">
    <div class="container">
        <div class="flex flex-col text-center items-center pt-12 pb-12">
            <p class="witter text-[55px] text-fYellow">Hello . . .</p>
            <p class="text-center text-[40px] uppercase text-headingColor cormorant translate-x-12">Contact Us</p>

        </div>

        <div class="flex flex-row justify-around pb-5">
            <div class="flex flex-row items-center border border-black p-3 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="tel:+355694484000" class="flex flex-row">
                    ...
                    <span class="ml-3 red-hat text-[22px]">069 448 4000</span></a>
            </div>
            <div class="flex flex-row items-center border border-black p-3 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="mailto:fustanellafarm@gmail.com" class="flex flex-row">
                    ...
                    <span class="ml-3 red-hat text-[22px]">fustanellafarm@gmail.com</span></a>
            </div>
            <div class="flex flex-row items-center border border-black p-3 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="https://api.whatsapp.com/send?phone=06944844000" class="flex flex-row">
                    ...
                    <span class="ml-3 red-hat text-[22px]">069 448 4000</span>
                </a>
            </div>
        </div>
        ...
        <div class="flex flex-row justify-around items-end pt-10 pb-10 mx-auto">
            <form id="contact-form" class="w-[50%]">
                ...
                <div class="flex flex-col w-4/5 mx-auto pb-5">
                    <label for="email" class="mb-5 mt-5 uppercase text-[22px] cormorant">Email</label>
