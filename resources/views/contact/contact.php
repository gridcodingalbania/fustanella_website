<div class="xs:bg-white sm:bg-white lg:bg-[#f0f0f0] w-full">
    <div class="container">
        <div class="flex flex-col text-center items-center pt-12 pb-12">
            ...
            <p class="text-center xs:text-[28px] lg:text-[40px] uppercase text-headingColor cormorant xs:translate-x-6 sm:translate-x-6 xs:-translate-y-3 sm:-translate-y-3 lg:-translate-y-6 lg:translate-x-12">Contact Us</p>

        </div>

        <div class="xs:w-full sm:w-full lg:w-[95%] xl:w-[80%] 2xl:w-[80%] mx-auto flex xs:flex-col xs:items-center sm:items-center sm:flex-col lg:flex-row xs:justify-between lg:justify-evenly pb-5">
            <div class="flex xs:mb-3 sm:mb-3 lg:mb-0 flex-row items-center border border-black pl-5 pr-5 pt-2 pb-2 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="tel:<?php the_field("contact_phone_number"); ?>" class="flex flex-row items-center">
                    ...
                    <span class="ml-3 red-hat xs:text-[16px] sm:text-[16px] 2xl:text-[19px]"><?php the_field("contact_phone_number"); ?></span></a>
            </div>
            <div class="flex xs:mb-3 sm:mb-3 lg:mb-0 flex-row items-center border border-black pl-5 pr-5 pt-2 pb-2 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="mailto:<?php the_field("contact_email"); ?>" class="flex flex-row items-center">
                    ...
                    <span class="ml-3 red-hat xs:text-[16px] sm:text-[16px] 2xl:text-[19px]"><?php the_field("contact_email"); ?></span></a>
            </div>
            <div class="flex xs:mb-3 sm:mb-3 lg:mb-0 flex-row items-center border border-black pl-5 pr-5 pt-2 pb-2 cursor-pointer hover:bg-headingColor hover:text-white transition-all make-svg-white">
                <a href="https://api.whatsapp.com/send?phone=<?php the_field("contact_wp_nr_prefix"); ?>" class="flex flex-row items-center">
                    ...
                    <span class="ml-3 red-hat xs:text-[16px] sm:text-[16px] 2xl:text-[19px]"><?php the_field("contact_wp_nr"); ?></span>
                </a>
            </div>
        </div>

        <div class="xs:w-full sm:w-full lg:w-[90%] 2xl:w-[80%] flex xs:flex-col-reverse sm:flex-col-reverse lg:flex-row justify-between items-end pt-10 pb-24 mx-auto">
...
<div class="w-full overflow-x-hidden">
    <div class="container">
        <div class="flex-col text-center xs:hidden sm:hidden lg:flex items-center pt-12 pb-12">
            ...
            <p class="text-center text-[40px] uppercase text-headingColor cormorant translate-x-12 -translate-y-6">Direction</p>
            <p class="text-center text-[22px] mt-12 red-hat font-light"><?php the_field("contact_location"); ?></p>
        </div>
