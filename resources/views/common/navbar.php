 <script src="https://cdn.tailwindcss.com"></script>
    ...
    <div class="2xl:flex lg:flex nav:hidden 2xl:pl-28 xl:pl-8 lg:pl-1.5 2xl:pr-14 xl:pr-2.5 lg:pr-1.5 pt-9 ">
        ...
        <div class="m-auto 2xl:text-xl lg:text-sm">
            <a class="menuML Cormorant-Bold" href="#" id="farmA" style="color: green;border-bottom: 1px solid;"  onClick="toggleDiv('farm')">Farm</a>
            <a class="menuML Cormorant-Bold" href="#" id="r&fA" onClick="toggleDiv('r&f')">Restaurant & Food</a>
            <a class="menuML Cormorant-Bold" href="#" id="eventsA" onClick="toggleDiv('events')">Events</a>
            <a class="menuML Cormorant-Bold" href="#" id="galleryA" onClick="toggleDiv('gallery')">Gallery</a>
            <a class="menuML Cormorant-Bold" href="#" id="contactA" onClick="toggleDiv('contact')">Contact us</a>
            <a class="menuML Cormorant-Bold" href="#" id="wWsA" onClick="toggleDiv('wWs')">Work With us</a>
        </div>
         ...
         <!-- <div>
            <div id="myNav" class="h-full w-full fixed top-0 left-0" style="display:none;  background-color:white;">
             <div class="relative w-full h-full text-black">
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Home</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">About Us</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Restaurant & Food</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Events</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Gallery</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Contact us</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Work With us</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Book a Table</a>
                <a class="ml-10 mt-2 Cormorant-Bold text-[30px] block duration-[3]" href="#">Book a Room</a>
        </div>
