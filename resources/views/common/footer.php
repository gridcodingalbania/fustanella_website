...
<div class="2xl:flex xl:flex lg:flex nav:grid bg-green-1000 justify-evenly p-20 text-center text-white ">
    <div class="2xl:grid lg:grid nav:hidden">
        ...
        <a class="text-base leading-7 red-hat font-[400]" href="privacy-cookie">Privacy Policy & Cookie</a>
    ...
    <div class="2xl:hidden lg:hidden nav:grid py-[40px] m-auto w-fit">
        ...
        <a class="text-[18px] leading-[27px] font-[300] red-hat" href="privacy-cookie">Privacy Policy & Cookie</a>
        <div class="flex justify-evenly mt-10">
            <a href="book-a-table"><img class="m-auto footHover" src="<?php echo get_image('FooterDineImage.svg');?>" /></a>
            <a href=""><img class="m-auto footHover" src="<?php echo get_image('FooterStayImage.svg');?>" /></a>
        </div>
