...
<div class="2xl:flex xl:flex lg:flex nav:grid bg-green-1000 justify-evenly p-20 text-center text-white ">
    ...
    <div class="grid w-fit">
        ...
        <div class="flex 2xl:justify-evenly sm:justify-evenly justify-between mt-10">
            <a href="https://www.facebook.com/fustanella/"><img class="m-auto footHover" src="<?php echo get_image('FooterFBicon.svg');?>" /></a>
            <a href="https://www.instagram.com/fustanellafarm/"><img class="m-auto footHover" src="<?php echo get_image('FooterIGicon.svg');?>" /></a>
    ...
    <p class="2xl:hidden lg:hidden nav:block text-[16px] red-hat mt-[50px] font-[400] mx-[-12%] ">Copyright gridcartels.com © 2022. <br>
