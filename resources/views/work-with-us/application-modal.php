    ...
    <div class="modal-content">
        <div class="flex flex-col">
            <div class="flex flex-row justify-end">
                <div class="cursor-pointer bg-[#D9D9D9] p-8" id="close_modal">
                ...
                <form id="application-form" enctype="multipart/form-data" class="w-[90%]">
                    ...
                    <div class="flex flex-col w-4/5 mx-auto">
                        ...
                        <label for="file" class="flex flex-col justify-around  w-full bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                            <div class="flex flex-row items-center p-5 h-[120px]">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 ml-12" id="file-description">Click or Drag files here to upload (.pdf, .doc, .docx allowed)</p>
                            </div>
