...
<div class="lg:flex lg:flex-row flex-wrap items-center lg:justify-center xs:grid sm:grid xs:grid-cols-2 sm:grid-cols-2 xs:justify-items-center xs:gap-4 sm:gap-6 lg:gap-12">
    <?php if (have_rows('open_vacancies')) : ?>
        ...
        ?>
            ...
            <div class="bg-[#F0F0F0] card-shadows flex flex-col items-center justify-around xs:w-[154px] sm:w-[180px] md:w-[300px] xl:w-[300px] 2xl:w-[384px] xs:h-[148px] sm:h-[148px] md:h-[200px] xl:h-[300px] 2xl:h-[384px] ">
                <p class="cormorant uppercase xs:text-[14px] sm:text-[14px] lg:text-[24px]"><?php the_sub_field('opened_position'); ?></p>
                <?php if ($image) : ?>
                    <img src="<?php echo $picture ?>" class="xs:w-[38px] sm:w-[38px] lg:w-[52px] 2xl:w-[84px]">
                <?php endif; ?>
