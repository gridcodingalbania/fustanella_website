...
<?php get_header(); ?>
 <div style="background:#F5F5F5;">
    <div class="text-center bg-gray94 pb-[100px]">
        ...
        <p class="2xl:mx-[400px] xl:mx-[300px] lg:mx-[200px] md:mx-[200px] sm:mx-[100px] mx-[50px] m-auto mt-[25px]  red-hat text-[20px] leading-[29px]"><?php the_field('restaurant_paragraph'); ?></p>
