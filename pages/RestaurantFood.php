 ...
 <div style="background:#F5F5F5;">
    <div class="bgimg-5"  style=" background-image: url('<?php the_field('first_image_restaurant'); ?>');">
        <div class="text-center bg-gray94 2xl:pb-[100px] md:pb-[80px] sm:pb-[45px] pb-[40px]">
            ...
            <p class="cormorant text-green-1000 2xl:text-[45px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] leading-[39px] font-medium uppercase px-[5%]"><?php the_field('lorem_restaurant_word'); ?></p>
            <p class="2xl:mx-[500px] xl:mx-[300px] lg:mx-[200px] md:mx-[200px] sm:mx-[100px] mx-[45px] m-auto mt-[25px]  red-hat 2xl:text-[20px] lg:text-[19px] sm:text-[18px] text-[16px] 2xl:leading-[29px] md:leading-[29px] sm:leading-[24px] leading-[24px]"><?php the_field('restaurant_first_paragraph'); ?></p>
            <p class="2xl:mx-[500px] xl:mx-[300px] lg:mx-[200px] md:mx-[200px] sm:mx-[100px] mx-[45px] m-auto mt-[25px]  red-hat 2xl:text-[20px] lg:text-[19px] sm:text-[18px] text-[16px] 2xl:leading-[29px] md:leading-[29px] sm:leading-[24px] leading-[24px]"><?php the_field('restaurant_second_paragraph'); ?></p>
            <div class="2xl:flex sm:flex grid justify-center gap-[16px] mt-[80px]">
            <a href="book-a-table"><button class="2xl:px-[65px] sm:px-[65px] px-[69px] 2xl:py-[15px] sm:py-[15px] py-[16px] border  border-black hover:bg-headingColor hover:text-white transition-all"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px] font-semibold"><?php the_field('book_a_table_button'); ?></span></button></a>
            </div>
        </div>
    ...
    <div class="text-center pb-[100px]">
        ...
        <p class="2xl:mx-[500px] xl:mx-[300px] lg:mx-[200px] md:mx-[200px] sm:mx-[100px] mx-[45px] m-auto mt-[25px]  red-hat 2xl:text-[20px] lg:text-[19px] sm:text-[18px] text-[16px] 2xl:leading-[29px] md:leading-[29px] sm:leading-[24px] leading-[24px]"><?php the_field('organic_paragraph'); ?></p>
    </div>
