 ...
 <div style="background:#F5F5F5;">
    <div class="bgimg-4"  style=" background-image: url('<?php the_field('first_image_farm_page'); ?>');">
        <div class="text-center bg-gray94 2xl:pb-[100px] md:pb-[80px] sm:pb-[45px] pb-[40px]">
            ...
            <a href="book-a-table" class="pulse2"><button class="2xl:px-[65px] sm:px-[65px] px-[69px] 2xl:py-[15px] sm:py-[15px] py-[16px]  border  border-black"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px] font-semibold"><?php the_field('book_a_table_button'); ?></span></button></a>
