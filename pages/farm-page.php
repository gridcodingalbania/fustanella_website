 ...
 <div style="background:#F5F5F5;">
    <div class="bgimg-4"  style=" background-image: url('<?php the_field('first_image_farm_page'); ?>');">
        <div class="text-center bg-gray94 2xl:pb-[100px] md:pb-[80px] sm:pb-[45px] pb-[40px]">
            ...
            <p class="cormorant text-green-1000 2xl:text-[45px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] leading-[39px] font-medium uppercase"><?php the_field('lorem_word'); ?></p>
            ...
            <a href="" class="pulse2"><button class="2xl:px-[65px] sm:px-[65px] px-[69px] 2xl:py-[15px] sm:py-[15px] py-[16px]  border  border-black"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px] font-semibold"><?php the_field('book_a_table_button'); ?></span></button></a>
            <a href="" class="pulse2"><button class="2xl:px-[65px] sm:px-[65px] px-[69px] 2xl:py-[15px] sm:py-[15px] py-[16px] border  border-black 2xl:mt-0 nav:mt-[5%] mt-0"> <span class="uppercase cormorant  2xl:text-[24px] sm:text-[24px] text-[18px] font-semibold"><?php the_field('book_a_room_button'); ?></span></button></a>
            </div>
        </div></div>
        <!-- <div >
            <img class="2xl:block lg:block sm:block hidden" src="<?php the_field('first_image_farm_page'); ?>" alt="">
            <img class="2xl:hidden lg:hidden sm:hidden block w-full" src="<?php the_field('first_image_farm_page_mobile'); ?>" alt="">
        </div> -->
    ...
    <div class="2xl:block md:block sm:hidden hidden">
