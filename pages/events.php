...
<div class="background: #F5F5F5;">
    <div class="text-center">
        <p style="color:#90B03E;" class="witter text-[55px] leading-[48px] mr-[260px] pt-[105px]">Cheers...</p>
        <p class="cormorant text-green-1000 text-[45px] leading-[39px] font-medium uppercase">Our Events</p>
        <p class="2xl:mx-[400px] xl:mx-[300px] lg:mx-[200px] md:mx-[200px] sm:mx-[100px] mx-[50px] m-auto mt-[25px]  red-hat text-[20px] leading-[29px]"><?php the_field('header_text'); ?></p>
    </div>
