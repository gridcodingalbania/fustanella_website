...
<div style="background:#F5F5F5;">
    <div class="bgimg-6"  style=" background-image: url('<?php the_field('first_image_about_us'); ?>');">
        <div class="text-center bg-gray94 2xl:pb-[100px] md:pb-[80px] sm:pb-[45px] pb-[40px]">
            ...
            <p class="cormorant text-green-1000 2xl:text-[45px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] leading-[39px] font-medium uppercase px-[5%]"><?php the_field('lorem_word_first'); ?></p>
    ...
    <div class="bgimg-7"  style=" background-image: url('<?php the_field('second_image_about_us'); ?>');">
        <div class="text-center bg-gray94 2xl:pb-[100px] md:pb-[80px] sm:pb-[45px] pb-[40px]">
            ...
            <p class="cormorant text-green-1000 2xl:text-[45px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] leading-[39px] font-medium uppercase px-[5%]"><?php the_field('lorem_word_sec'); ?></p>
